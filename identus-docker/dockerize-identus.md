...
We do that on the [Dockerfile](./cloud-agent-M4-workaround/Dockerfile) (for version 2.0.0) where we hard-code the workaround.

So on your docker compose file [docker-compose.yaml](./docker-compose.yaml) you need to use the new image we just created.
